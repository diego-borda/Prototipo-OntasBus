...
//headerContenido.style.width = '100%';

/*

// Añadimos un evento click al botón
botonToggle.addEventListener('click', () => {
  // Alternamos la clase "oculto" del menú lateral al hacer clic en el botón
  menuLateral.classList.toggle('oculto');
  
  // Si el menú lateral está visible
  if (!menuLateral.classList.contains('oculto')) {
    menuLateral.style.width = '30%';
    headerContenido.style.width = '70%';
  } else {
    // Si el menú lateral está oculto
    menuLateral.style.width = '0';
    headerContenido.style.width = '100%';
  }
});
